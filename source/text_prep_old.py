...
def twit2vec(df, config_path):
    """
    Function for processing data and preparing it for model training.
    Arguments: df -- the input DataFrame containing the data
    config_path -- the path to the YAML configuration file with parameters
    Returns: X_train -- the training feature dataset
    X_test -- the test feature dataset
    y_train -- the training label dataset
    y_test -- the test label dataset
    """
